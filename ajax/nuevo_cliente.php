<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO vis_clientes (c_nom_cli, c_tel_cli, c_email_cli, c_dir_cli, c_rif_cli, c_cod_ent, c_por_dis, c_cod_reg, c_fec_agre) VALUES ('$nombre','$telefono','$email','$direccion','$rif','$ent','$por','$region','$date_added')";
