  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <h4><i class='glyphicon glyphicon-sort-by-order'></i> Carga Masiva de Datos: Inventario o Productos Disponibles</h4>
		</div>
						    ...
						    <div class="col-sm-3">
                               <div class="form-group">
                                  <div class="fileUpload btn btn-primary">
                                        <span>Busca el archivo "Inventario.xlsx" que tiene la data </span>
							...
							<div class="col-sm-8">
                               <div class="form-group">
                                  <div class="fileUpload btn btn-primary">
										...
										<a class="btn btn-primary btn-lg" href="Descargas/Inventario.xlsx">Inventario.XLSX</a>								        
                                  </div>
                               </div>
                            </div>
						</div>				
	...
	<script type="text/javascript" src="js/carga_inv.js"></script> 
